...
- **Media asset**: A user-uploaded or URL-imported file retained for the disclosed period and optionally assigned to one project. Relay does not generate image or video assets.
