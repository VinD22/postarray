...
export const draftFromBriefPrompt: PromptModule<DraftFromBriefResult> = {
  ...
  requiredVariables: ['brief', 'contentKind', 'locale', 'projectVoice'],
  ...
  instruction: [
    ...
    'list what is missing in "rationale". Match the project voice exactly. Write in the',
    'requested locale. Do not add hashtags unless the project uses them. Do not write a call',
...
export const transcreatePrompt: PromptModule<TranscreateResult> = {
  ...
  instruction: [
    ...
    '',
    'This is not a literal translation. Keep the intent, the register and the project voice,',
