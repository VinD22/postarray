...
import { buildConnectorContractCases, CONTRACT_HARNESS_PROVIDERS } from './contract.harness';
...
describe.each(buildConnectorContractCases())(
  '$provider connector satisfies the contract',
  (contract) => {
