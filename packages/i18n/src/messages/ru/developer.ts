...
export const developerMessages = {
  ...
  'developer.serviceAccount.scopeBrands': 'Brand и учетные записи, которые он может использовать',
  ...
  'developer.apps.subtitle':
    'Позвольте другому продукту действовать через Relay с разрешениями, предоставленными ему пользователем.',
  ...
  'developer.consent.brands': 'Brand и аккаунты',
