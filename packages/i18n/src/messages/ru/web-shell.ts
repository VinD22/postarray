...
export const webShellMessages = {
  ...
  'shell.demo.howToConnect':
    'Установите NEXT_PUBLIC_POSTARRAY_API_URL и перезапустите приложение, чтобы использовать текущие данные.',
  ...
  'onboarding.workspace.help':
    'В рабочей области хранятся ваши проекты, подключенные учетные записи, черновики и квитанции. Вы можете создать больше позже.',
