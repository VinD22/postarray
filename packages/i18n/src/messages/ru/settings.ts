...
export const settingsMessages = {
  ...
  'settings.projects.blockedTerms': 'Заблокированные термины',
  'settings.projects.disclosureDefaults': 'Настройки раскрытия информации по умолчанию',
  'settings.projects.domains': 'Домены',
  'settings.projects.glossary.title': 'Глоссарий',
  'settings.projects.glossary.term': 'Срок',
  'settings.projects.glossary.preferred': 'Предпочтительный перевод',
  'settings.projects.glossary.prohibited': 'Не переводите как',
  'settings.projects.glossary.context': 'Контекст',
  'settings.projects.glossary.keepUntranslated': 'Оставить без перевода',
  'settings.projects.localeRules.title': 'Правила локали',
  'settings.projects.localeRules.formality': 'Формальность',
  'settings.projects.localeRules.pronouns': 'Местоимения и почетные знаки',
  'settings.projects.localeRules.idioms': 'Идиомы, которых следует избегать',
  'settings.projects.localeRules.emoji': 'Нормы смайлов и хэштегов',
  'settings.projects.localeRules.legal': 'Региональная юридическая информация',
  'settings.projects.localeRules.cta': 'Призыв к действию по рынку',
  'settings.projects.localeRules.reviewedExamples': 'Примеры, одобренные местным рецензентом',
