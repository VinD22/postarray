...
export const statusMessages = {
  ...
  'empty.approvals.body': 'Здесь отображаются запросы на одобрение ваших брендов.',
  ...
  'confirm.publishNow.body':
    '{count, plural, one {Это немедленно публикуется в # аккаунте} few {Это немедленно публикуется в # аккаунте} many {Это немедленно публикуется в # аккаунте} other {Это немедленно публикуется в # аккаунте}}. Его невозможно отозвать из Relay.',
