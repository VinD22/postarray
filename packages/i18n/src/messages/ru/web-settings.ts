...
export const webSettingsMessages = {
  ...
  'settings.ui.security.socialPermissionsBody':
    'Что каждая подключенная учетная запись позволила сделать Relay, судя по снимку возможностей, сделанному во время подключения.',
  ...
  'settings.ui.referral.description':
    'Поделитесь Relay с раскрытой ссылкой. Комиссия никогда не ставит условием положительного отзыва.',
  ...
  'developer.ui.apps.emptyBody':
    'Зарегистрируйте приложение, когда другому продукту необходимо действовать от имени пользователя Relay. Для собственной автоматизации используйте вместо этого сервисную учетную запись.',
  ...
  'developer.ui.apps.scopeGroupHelp.reversible':
    'Это позволяет приложению создавать или редактировать элементы внутри Relay. Ничто не достигает платформы.',
  ...
  'billing.ui.allowanceNoMedia':
    'Генерация изображений и видео не включены и не продаются. Relay не создает медиафайлы.',
  ...
  'billing.ui.noSubscriptionBody':
    'Начните семидневную пробную версию для публикации. Polar выбирает способ оплаты и сегодня ничего не взимает.',
  ...
  'growth.ui.ugc.honesty':
    'Здесь планируется кампания, которую вы проводите с реальными людьми. Relay не находит авторов, не связывается с ними, не пишет отзывы и не создает контент для клиентов.',
  ...
  'growth.ui.opportunities.prepareManual':
    'Вы отправляете это сами на их сайте. Relay не заполняет формы, не создает учетные записи и не отправляет никому электронные письма.',
  ...
  'growth.ui.tools.emptyExample':
    'В записи указывается, для чего он лучше всего подходит, почему он соответствует вашему плану, чего он не может делать, какие навыки ему нужны, как выходные данные возвращаются в Relay и когда цена проверялась в последний раз.',
