...
/**
 * Italian is a beta interface locale. Legal, billing, and consent statements
...
export const it = {
  ...
  ...growthMessages,
  ...withoutBetaEnglishFallbacks(settingsMessages, 'it'),
  ...developerMessages,
  ...authMessages,
  ...onboardingMessages,
  ...emailMessages,
  ...
  ...webDemoMessages,
  ...withoutBetaEnglishFallbacks(webMarketingMessages, 'it'),
  ...webPlatformsMessages,
  ...withoutBetaEnglishFallbacks(webSettingsMessages, 'it'),
...
export type ItalianCatalog = typeof it;
