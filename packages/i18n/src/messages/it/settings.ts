...
export const settingsMessages = {
  ...
  'settings.role.manager.description': 'Gestisci marchi, connessioni, orari e regole.',
  ...
  'settings.role.scopeLabel': 'Limite a marchi e account',
  'settings.role.mfaRequired': "I proprietari devono utilizzare l'autenticazione a due fattori.",

  'settings.brands.title': 'Brands',
  'settings.brands.add': 'Aggiungi un marchio',
  'settings.brands.voice': 'Voce',
  'settings.brands.audience': 'Pubblico',
  'settings.brands.approvedClaims': 'Affermazioni approvate',
  'settings.brands.blockedTerms': 'Termini bloccati',
  'settings.brands.disclosureDefaults': 'Impostazioni predefinite in materia di divulgazione',
  'settings.brands.domains': 'Domini',
  'settings.brands.glossary.title': 'Glossario',
  'settings.brands.glossary.term': 'Termine',
  'settings.brands.glossary.preferred': 'Traduzione preferita',
  'settings.brands.glossary.prohibited': 'Non tradurre come',
  'settings.brands.glossary.context': 'Contesto',
  'settings.brands.glossary.keepUntranslated': 'Mantieni la traduzione non tradotta',
  'settings.brands.localeRules.title': 'Regole locali',
  'settings.brands.localeRules.formality': 'Formalità',
  'settings.brands.localeRules.pronouns': 'Pronomi e onorifici',
  'settings.brands.localeRules.idioms': 'Idiomi da evitare',
  'settings.brands.localeRules.emoji': 'Norme su emoji e hashtag',
  'settings.brands.localeRules.legal': 'Informativa legale regionale',
  'settings.brands.localeRules.cta': "Invito all'azione per mercato",
  'settings.brands.localeRules.reviewedExamples': 'Esempi approvati da un revisore nativo',
  ...
  'settings.signatures.description':
    'Testo di chiusura, hashtag, link o informative, suddivisi per marchio, piattaforma e lingua.',
  ...
  'settings.localization.contentLocalesHelp':
    'Le lingue in cui pubblichi. Ogni marchio può impostare regole e un glossario per lingua.',
