export const validationMessages = {
  ...
  'validation.disclosure_required.message': '依 {market} 的 Brand 規則，此貼文需要揭露。',
  ...
  'validation.schedule_outside_quiet_hours.message': '這落在為 {brand} 設定的安靜時段內。',
  'validation.duplicate_within_window.message':
    '在 {window} 內，已有非常相似的內容為 {account} 排程或發布。',
  'validation.blocked_term_present.message': '文字包含 {brand} 的封鎖詞彙。',
  'validation.unsupported_claim.message': '此聲明不在 {brand} 的核准聲明中。',
