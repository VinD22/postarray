...
export const webUseCaseMessages = {
  ...
  'web.useCases.clients.approach3': '報表也遵循同樣的邊界，因此每個客戶各自的報表是預設形式，而不是有人手動彙整的試算表。',
  ...
  'web.useCases.approvals.approach3': '此規則位於共用的應用程式層，因此網頁應用程式、REST API、MCP 伺服器、CLI 與 webhook 都必須遵守。沒有任何介面能繞過審閱。',
  ...
  'web.useCases.crossPlatform.lede': '一個構想、一次編輯，以及每個平台各自尊重該平台實際接受內容的版本。',
  ...
  'web.useCases.crossPlatform.approach3': '本網站任何地方顯示的每一項平台限制，都是從連接器登錄產生，並附有其來源文件與有人閱讀該文件的日期。',
