...
export const webPlatformsMessages = {
  ...
  'web.schedule.index.cohortNote': '此梯次是本產品正在建置以支援的平台集合，這是一項計畫，而非可用清單。',
  ...
  'web.schedule.limits.unavailable.body': '此版本尚未提供此平台的轉接器，因此沒有已記錄的上限可供顯示。捏造的數字會比完全沒有還糟。',
  ...
  'web.schedule.link.fixed': '每個連結都會被改寫為平台的縮網址，無論其實際長度為何，都計為 {count, plural, other {# 個字元}}。',
  ...
  'web.schedule.capabilities.unavailable.body': '此版本中沒有轉接器，因此登錄中沒有可回報的內容。一旦有實際內容可說明，此列就會出現在功能矩陣中。',
  'web.schedule.capabilities.matrixLink': '閱讀完整功能矩陣',

  'web.schedule.next.title': '接下來可以前往哪裡',
  'web.schedule.next.body': '功能矩陣將每個平台與每項功能整合在一張表格中。使用情境頁面則描述本產品正在圍繞建構的工作流程。',
  ...
  'web.meta.specsPlatform.description': '{platform} 已記錄的每項限制：內容為何、該數字所來自的官方文件，以及有人閱讀該文件的日期。',
  ...
  'web.specs.platform.limitsBody': '每一列都連結到一個獨立說明其數值的頁面，並附有其來源文件。此平台未記載的限制，不會有對應的列，也不會有頁面。',
  ...
  'web.specs.notice.body': '尚無任何連接器通過其完成定義。此頁面說明的是該平台強制執行的內容，並不代表本產品已在那裡發布。',
  ...
  'web.specs.constraint.characterLimit.description': '{platform} 對單一貼文的內文文字上限，並附有其來源的官方文件與有人閱讀該文件的日期。',
  ...
  'web.specs.constraint.titleLimit.description': '{platform} 強制執行的標題欄位上限，並附有其來源的官方文件與有人閱讀該文件的日期。',
  ...
  'web.specs.constraint.imageSize.description': '{platform} 接受的最大圖片檔案，並附有其來源的官方文件與有人閱讀該文件的日期。',
  ...
  'web.specs.constraint.videoSize.description': '{platform} 接受的最大影片檔案，並附有其來源的官方文件與有人閱讀該文件的日期。',
  ...
  'web.specs.constraint.videoLength.description': '發布到 {platform} 的影片可以有多長，並附有其來源的官方文件與有人閱讀該文件的日期。',
  ...
  'web.specs.constraint.imageCount.description': '{platform} 上一則貼文可容納多少張圖片，並附有其來源的官方文件與有人閱讀該文件的日期。',
  ...
  'web.specs.constraint.altTextLimit.description': '{platform} 對附加圖片強制執行的替代文字上限，並附有其來源的官方文件與有人閱讀該文件的日期。',
  ...
  'web.specs.constraint.fileTypes.description': '{platform} 接受哪些媒體類型，並附有其來源的官方文件與有人閱讀該文件的日期。',
} as const;
