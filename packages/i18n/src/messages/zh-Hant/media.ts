...
export const mediaMessages = {
  ...
  'mediaLib.derivative.originalKept':
    '原始檔案永遠不會被取代。每次編輯都會另存為一個版本，供你在撰寫貼文時選用。',
  ...
  'mediaLib.derivative.cropHint':
    '請輸入數字，或在任一欄位使用方向鍵。此處沒有任何步驟需要用到滑鼠。',
  ...
  'mediaLib.derivative.qualityHint':
    '較低的品質會產生較小的檔案。此設定適用於 JPEG 與 WebP。PNG 為無損格式，此設定對其無效。',
  ...
  'mediaLib.derivative.alreadyExists':
    '你先前已進行過完全相同的編輯，因此我們重複使用了該版本，而非再建立一次。',
