...
/** Traditional Chinese remains a beta interface locale until human review. */
export const zhHant = {
  ...navMessages,
  ...actionMessages,
  ...commonMessages,
  ...
  ...importMessages,
  ...mediaMessages,
  ...withoutBetaEnglishFallbacks(billingMessages, 'zh-Hant'),
  ...withoutBetaEnglishFallbacks(settingsMessages, 'zh-Hant'),
  ...developerMessages,
  ...emailMessages,
  ...digestMessages,
  ...authMessages,
  ...
  ...statusMessages,
  ...a11yMessages,
  ...withoutBetaEnglishFallbacks(webMarketingMessages, 'zh-Hant'),
  ...withoutBetaEnglishFallbacks(webSettingsMessages, 'zh-Hant'),
...
export type TraditionalChineseCatalog = typeof zhHant;
