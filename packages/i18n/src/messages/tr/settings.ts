...
export const settingsMessages = {
  ...
  'settings.projects.blockedTerms': 'Engellenen terimler',
  'settings.projects.disclosureDefaults': 'Disclosure defaults',
  'settings.projects.domains': 'Alanlar',
  'settings.projects.glossary.title': 'Sözlük',
  'settings.projects.glossary.term': 'Dönem',
  'settings.projects.glossary.preferred': 'Tercih edilen çeviri',
  'settings.projects.glossary.prohibited': 'Olarak tercüme etmeyin',
  'settings.projects.glossary.context': 'Bağlam',
  'settings.projects.glossary.keepUntranslated': 'Çevrilmemiş halde tut',
  'settings.projects.localeRules.title': 'Yerel kurallar',
  'settings.projects.localeRules.formality': 'Formalite',
  'settings.projects.localeRules.pronouns': 'Zamirler ve saygı sıfatları',
  'settings.projects.localeRules.idioms': 'Kaçınılması gereken deyimler',
  'settings.projects.localeRules.emoji': 'Emoji ve hashtag normları',
  'settings.projects.localeRules.legal': 'Regional legal disclosures',
  'settings.projects.localeRules.cta': 'Pazara göre eylem çağrısı',
