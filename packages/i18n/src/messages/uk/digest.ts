...
export const digestMessages = {
  ...
  'digest.empty':
    'Цього тижня поки немає чого підсумовувати. Опублікуйте щось, і це з’явиться тут.',
  'digest.regenerate': 'Перебудувати цей тиждень',
  'digest.generating': 'Створюємо підсумок цього тижня',
  'digest.source.deterministic':
    'Створено на основі ваших записів про публікації та власних вимірювань, без помічника написання.',
  'digest.source.ai':
    'Створено помічником на основі ваших записів. Кожне число перевірено за ними.',
  'digest.unavailable.aiOff':
    'Помічник написання вимкнений, тому це звичайна версія. Нічого не пропущено.',
  'digest.unavailable.rejected':
    'Версія помічника не відповідала вашим даним, тому її відхилено. Це звичайна версія.',
  ...
  'digest.metrics.noneYet':
    'Вимірювання за цей тиждень ще не надійшли. Це означає, що ми не знаємо, як виступили публікації, а не те, що вони виступили погано.',
  ...
  'digest.settings.description':
    'Короткий щотижневий лист про те, що вийшло і що ми змогли виміряти. Увімкнено за замовчуванням.',
