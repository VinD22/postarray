...
export const webShellMessages = {
  ...
  'shell.demo.howToConnect':
    'Установіть NEXT_PUBLIC_POSTARRAY_API_URL і перезапустіть програму, щоб використовувати живі дані.',
  ...
  'onboarding.workspace.help':
    'Робоча область містить ваші проекти, підключені облікові записи, чернетки та квитанції. Ви можете створити більше пізніше.',
