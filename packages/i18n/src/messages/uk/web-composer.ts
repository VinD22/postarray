...
export const webComposerMessages = {
  ...
  'composerWeb.entity.lookupNotBuilt':
    'Post Array не створив пошук сутностей для {provider} ще. Тим часом ні про що не догадується.',
  ...
  'composerWeb.links.domainDefault': 'Домен за замовчуванням Post Array',
  ...
  'composerWeb.assist.noMediaGeneration':
    'Post Array не створює зображень або відео. Занесіть готові файли в бібліотеку та опублікуйте їх тут.',
  ...
  'composerWeb.page.noConnectionsBody':
    'Чернетка потребує принаймні одного підключеного облікового запису, щоб Post Array знав обмеження, попередній перегляд і налаштування для показу.',
  ...
  'mediaLib.empty.body':
    'Завантажте зображення та відео, які вже є, або імпортуйте файл із URL. Post Array перевіряє тип і розмір кожного облікового запису, у якому ви публікуєте.',
  ...
  'mediaLib.import.scanPending':
    'Post Array записав джерело файлу. Публікація чекає завершення перевірки безпеки.',
  ...
  'mediaLib.provenance.unverified':
    'Ці подробиці надійшли з джерела, а не з Post Array. Перевірте їх, перш ніж покладатися на них.',
