...
export const statusMessages = {
  ...
  'confirm.publishNow.body':
    '{count, plural, one {Це публікує в # поточну рахунок} few {Це публікує в # рахунки повторно} many {Це публікує в # рахунки повторно} other {Це публікує в # рахунки повторно}}. Його не можна відкликати з Post Array.',
