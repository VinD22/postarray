...
export const settingsMessages = {
  ...
  'settings.projects.blockedTerms': 'Blokované výrazy',
  'settings.projects.disclosureDefaults': 'Výchozí nastavení zveřejňování',
  'settings.projects.domains': 'Domény',
  'settings.projects.glossary.title': 'Glosář',
  'settings.projects.glossary.term': 'Termín',
  'settings.projects.glossary.preferred': 'Preferovaný překlad',
  'settings.projects.glossary.prohibited': 'Nepřekládat jako',
  'settings.projects.glossary.context': 'Kontext',
  'settings.projects.glossary.keepUntranslated': 'Ponechat nepřeložené',
  'settings.projects.localeRules.title': 'Místní pravidla',
  'settings.projects.localeRules.formality': 'Formality',
  'settings.projects.localeRules.pronouns': 'Zájmena a čestná jména',
  'settings.projects.localeRules.idioms': 'Idiomy, kterým je třeba se vyhnout',
  'settings.projects.localeRules.emoji': 'Normy pro emotikony a hashtagy',
  'settings.projects.localeRules.legal': 'Regionální právní informace',
  'settings.projects.localeRules.cta': 'Výzva k akci podle trhu',
  'settings.projects.localeRules.reviewedExamples': 'Příklady schválené nativním recenzentem',
