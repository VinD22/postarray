...
/**
 * The Czech beta catalog. This is the source of truth for every user visible
 ...
 */
/**
 * Czech is a beta interface locale. Legal, billing, and consent statements
...
export const cs = {
  ...
  ...withoutBetaEnglishFallbacks(settingsMessages, 'cs'),
  ...developerMessages,
  ...authMessages,
  ...onboardingMessages,
  ...emailMessages,
  ...
  ...withoutBetaEnglishFallbacks(webMarketingMessages, 'cs'),
  ...webPlatformsMessages,
  ...withoutBetaEnglishFallbacks(webSettingsMessages, 'cs'),
...
/** The Czech catalog type. A translated catalog is a partial of this. */
export type CzechCatalog = typeof cs;
