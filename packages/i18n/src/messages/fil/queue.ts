...
export const queueMessages = {
  ...
  'queue.rules.count':
    '{count, plural, =0 {Walang panuntunan} one {# panuntunan} other {# na panuntunan}}',
  ...
  'queue.field.minimumGapHelp':
    'Bilang ng minuto sa pagitan ng dalawang post. Zero ang ibig sabihin ay walang panuntunan sa espasyo.',
  ...
  'queue.field.priorityHelp':
    'Ang panuntunang may pinakamataas na priyoridad na makapag-alok ng slot ang gagamitin.',
  ...
  'queue.reason.noMinimumGap':
    'Walang pinakamababang agwat sa pagitan ng mga post ang itinakda ng panuntunang ito.',
  'queue.reason.dailyCap':
    'May pinakamataas na {limit} post ang araw na iyon, at hindi pa ito puno.',
  ...
  'queue.reason.priorityChosen':
    'May priyoridad na {priority} ang panuntunang ito, ang pinakamataas na makakapag-alok.',
