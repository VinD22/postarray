...
export const importMessages = {
  ...
  'import.upload.project': 'Varumärke',
  'import.upload.projectHelp': 'Varje rad i en fil hör till detta varumärke.',
  ...
  'import.column.project': 'Varumärkets namn eller id som raden hör till.',
