export const webPlatformsMessages = {
  ...
  'web.schedule.value.characters': '{count, plural, one {# caractère} many {# caractères} other {# caractères}}',
  'web.schedule.value.files': '{count, plural, =0 {Aucun} one {# fichier} many {# fichiers} other {# fichiers}}',
