export const postingSetMessages = {
  ...
  'calendar.hold.byBilling': 'Mis en pause le {date} parce que ce workspace a perdu l\'accès complet.',
  ...
  'calendar.hold.blocked.finished': 'Cette publication est déjà terminée, il n\'y a donc rien à mettre en pause.',
  ...
  'set.empty.body': 'Créez-en un pour arrêter de reconstruire la même liste de comptes à chaque publication.',
  'set.create': 'Nouveau Set',
  'set.edit': 'Modifier le Set',
  'set.archive': 'Archiver le Set',
  'set.archived': 'Archivé',
  'set.archivedNote': 'Les Sets archivés sont masqués dans le sélecteur. Les publications créées à partir d\'eux restent inchangées.',
  'set.showArchived': 'Afficher les archivés',
  'set.saved': 'Set enregistré.',
  'set.archivedToast': 'Set archivé. Les publications déjà créées à partir de lui restent inchangées.',
  ...
  'set.field.targetsHint': 'Chaque compte avec lequel démarre une publication créée à partir de ce Set.',
  'set.field.targetCount': '{count, plural, =0 {Aucun compte} one {# compte} many {# comptes} other {# comptes}}',
  'set.field.signature': 'Signature',
  'set.field.signatureNone': 'Aucune signature',
  'set.field.approval': 'Approbation',
  'set.field.approvalHint': 'L\'approbation dont a besoin une publication créée à partir de ce Set avant de pouvoir être publiée.',
  ...
  'set.defaults.empty': 'Aucune valeur par défaut par plateforme. Chaque compte part de la publication maîtresse.',
  ...
  'targetMemory.setting.cleared': 'Réglage enregistré. Les sélections enregistrées dans ce projet ont été supprimées.',
