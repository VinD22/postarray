export const importMessages = {
  ...
  'import.upload.fieldHelp':
    'Sélectionnez un fichier, ou collez les lignes dans la zone ci-dessous.',
  'import.upload.paste': 'Ou collez le texte CSV',
  'import.upload.pasteHelp':
    "Incluez la ligne d'en-tête. Tout est vérifié avant que quoi que ce soit soit créé.",
  ...
  'import.column.external_row_id':
    'Votre propre identifiant pour la ligne. Doit être unique dans le fichier.',
  ...
  'import.column.time_zone':
    'Le fuseau IANA dans lequel cette heure locale est lue, par exemple Europe/Berlin.',
  'import.column.media':
  ...
  'import.apply.confirm':
    'Appliquer {count, plural, one {# ligne} many {# lignes} other {# lignes}}',
  ...
  'import.results.applied':
    '{count, plural, one {# brouillon créé} many {# brouillons créés} other {# brouillons créés}}',
  ...
  'import.results.failed':
    '{count, plural, one {# ligne a échoué} many {# lignes ont échoué} other {# lignes ont échoué}}',
  ...
  'import.error.duplicateRowId':
    "L'identifiant de ligne {value} est utilisé plus d'une fois dans ce fichier.",
  ...
  'import.error.alreadyApplied':
    'Cette ligne a déjà créé un brouillon, elle a donc été laissée telle quelle.',
