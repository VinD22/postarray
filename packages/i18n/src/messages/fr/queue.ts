export const queueMessages = {
  ...
  'queue.rules.count':
    '{count, plural, =0 {Aucune règle} one {# règle} many {# règles} other {# règles}}',
  ...
  'queue.field.nameHelp':
    'Un nom que vous reconnaîtrez plus tard, par exemple Matinées en semaine.',
  ...
  'queue.field.minimumGapHelp':
    "Minutes entre deux publications. Zéro signifie aucune règle d'espacement.",
  ...
  'queue.field.priorityHelp':
    'La règle de priorité la plus haute pouvant offrir un créneau est celle utilisée.',
  ...
  'queue.windows.empty':
    'Pas encore de créneau. Une règle sans créneau ne peut jamais offrir de plage.',
  ...
  'queue.blackouts.help':
    'Dates où ce projet ne publiera pas, lues dans le fuseau horaire de la règle.',
  ...
  'queue.reason.fallbackFirstFreeHour':
    'La première heure libre à partir de maintenant a été utilisée.',
  ...
  'queue.reason.minimumGap':
    "Il est espacé d'au moins {minutes} minutes de toute autre publication.",
  'queue.reason.noMinimumGap': 'Cette règle ne définit aucun écart minimum entre les publications.',
  'queue.reason.dailyCap':
    "Ce jour accueille au maximum {limit} publications, et il n'est pas complet.",
  ...
  'queue.reason.priorityChosen':
    'Cette règle a la priorité {priority}, la plus haute qui pouvait offrir.',
