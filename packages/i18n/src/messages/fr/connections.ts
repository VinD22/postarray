...
export const connectionMessages = {
  ...
  'connection.permissions.explainBeforeOAuth':
    'Post Array demandera {provider} pour ces autorisations. Vous pouvez vous déconnecter à tout moment.',
  ...
  'connection.group.description':
    'Les projets gardent séparés chaque produit ou client et ses comptes.',
  ...
  'connection.oauth.noEligibleAccountsShort':
    'Aucun compte de cette connexion {provider} ne peut être relié.',
  'connection.oauth.claimFailed': 'Ces comptes n’ont pas pu être reliés',
  'connection.oauth.claimFailedAction':
    'Rien n’a été modifié sur la plateforme. Réessayez, et si l’échec persiste, recommencez la connexion.',
  ...
  'capability.explain.supported': "Post Array peut le faire pour ce compte aujourd'hui.",
  ...
  'capability.explain.not_implemented':
    "{provider} le propose, mais Post Array ne l'a pas encore construit. C'est sur la feuille de route du connecteur.",
