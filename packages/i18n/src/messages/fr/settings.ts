...
export const settingsMessages = {
  ...
  'settings.brands.title': 'Marques',
  'settings.brands.add': 'Ajouter une marque',
  'settings.brands.voice': 'Voix',
  'settings.brands.audience': 'Public',
  'settings.brands.approvedClaims': 'Réclamations approuvées',
  'settings.brands.blockedTerms': 'Conditions bloquées',
  'settings.brands.disclosureDefaults': 'Valeurs par défaut de divulgation',
  'settings.brands.domains': 'Domaines',
  'settings.brands.glossary.title': 'Glossaire',
  'settings.brands.glossary.term': 'Terme',
  'settings.brands.glossary.preferred': 'Traduction préférée',
  'settings.brands.glossary.prohibited': 'Ne traduisez pas par',
  'settings.brands.glossary.context': 'Contexte',
  'settings.brands.glossary.keepUntranslated': 'Garder non traduit',
  'settings.brands.localeRules.title': 'Règles locales',
  'settings.brands.localeRules.formality': 'Formalité',
  'settings.brands.localeRules.pronouns': 'Pronoms et titres honorifiques',
  'settings.brands.localeRules.idioms': 'Expressions idiomatiques à éviter',
  'settings.brands.localeRules.emoji': 'Normes sur les emojis et les hashtags',
  'settings.brands.localeRules.legal': 'Divulgations juridiques régionales',
  'settings.brands.localeRules.cta': "Appel à l'action par marché",
  'settings.brands.localeRules.reviewedExamples': 'Exemples approuvés par un évaluateur natif',
