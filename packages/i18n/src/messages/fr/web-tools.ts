export const webToolsMessages = {
  ...
  'web.tools.shared.copyFailed': 'Votre navigateur a bloqué la copie. Sélectionnez le texte et copiez-le.',
  ...
  'web.tools.utm.summary': 'Construisez une URL de campagne étiquetée sans abîmer la chaîne de requête qu\'elle avait déjà.',
  ...
  'web.tools.preflight.field.byteSize.help': 'Le plus grand fichier unique. Laissez vide pour sauter.',
  ...
  'web.tools.preflight.finding.linkActual': 'Les liens comptent selon les caractères qu\'ils occupent.',
  ...
  'web.tools.utm.field.campaign.help': 'Le lancement, la promotion ou le thème auquel appartient ce lien.',
  ...
  'web.tools.timeZone.field.audience.help': 'Choisissez les fuseaux où se trouvent réellement vos lecteurs.',
  ...
  'web.tools.timeZone.result.stable': 'Aucun changement de décalage dans les quatre prochaines semaines.',
  ...
  'web.tools.timeZone.faq.storage.q': 'Comment une publication planifiée devrait-elle stocker son heure ?',
  ...
  'web.tools.engagementRate.field.followers.help': 'La taille du compte au moment de la publication.',
  'web.tools.engagementRate.field.impressions.label': 'Impressions',
  'web.tools.engagementRate.field.impressions.help': 'Total des vues, y compris une personne qui a vu deux fois.',
