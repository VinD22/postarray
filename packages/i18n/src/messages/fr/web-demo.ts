export const webDemoMessages = {
  ...
  'web.demo.schedule.approval': 'Une approbation est requise avant que quoi que ce soit puisse être envoyé.',
  ...
  'web.demo.week.caption': 'Les mêmes trois publications sur le calendrier, lues dans le fuseau horaire du projet.',
  ...
  'web.demo.digest.footer': 'Les analyses en direct apparaissent ici au fur et à mesure que vos publications sortent.',
