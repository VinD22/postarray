export const mediaMessages = {
  ...
  'mediaLib.derivative.noChanges':
    "Rien à enregistrer pour l'instant. Changez une valeur ci-dessus.",
  ...
  'mediaLib.derivative.empty':
    "Pas encore de version modifiée. L'original est le seul fichier ici.",
  ...
  'mediaLib.derivative.processing':
    'Cette version est en cours de création. Elle apparaîtra ici une fois prête.',
  ...
  'error.media_derivative_no_operations.message':
    "Choisissez au moins une modification avant d'enregistrer une version.",
