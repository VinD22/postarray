...
export const developerMessages = {
  ...
  'developer.serviceAccount.scopeBrands': 'Brands e contas que ele pode usar',
  ...
  'developer.apps.subtitle':
    'Deixe outro produto agir através de Relay com as permissões que um usuário concede a ele.',
  ...
  'developer.consent.brands': 'Brands e contas',
