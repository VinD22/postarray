...
export const validationMessages = {
  ...
  "validation.media_count_exceeded.message": "{provider} 最多接受 {limit, plural, one {# file} other {# files}} 。这篇文章有{count}。",
  "validation.media_type_unsupported.message": "{provider} 不接受 {mimeType} 文件。",
  "validation.media_aspect_ratio_unsupported.message": "该文件是 {actual}。 {provider} 需要 {min} 和 {max} 之间的比率。",
  "validation.media_aspect_ratio_unsupported.hint": "使用平台预设对其进行裁剪以解决此问题。",
  "validation.media_resolution_too_low.message": "该文件是 {actual}。 {provider} 至少需要 {required}。",
  "validation.media_duration_too_long.message": "该视频是{actual}。此帐户最多接受 {provider} {limit}。",
  ...
  "validation.media_mixed_types_unsupported.message": "{provider} 无法在同一篇文章中发布图像和视频。",
  "validation.alt_text_missing.message": "{count, plural, one {# image} other {# images}} 上缺少替代文本。",
  ...
  "validation.mention_unresolved.hint": "从搜索结果中选择帐户，或删除提及。纯文本永远不会作为本机标签发布。",
  "validation.hashtag_count_exceeded.message": "{count} 主题标签。 {provider} 比 {limit} 更被视为垃圾邮件。",
  ...
  "validation.duplicate_within_window.message": "已在 {window} 内为 {account} 安排或发布了非常相似的内容。",
  ...
  "validation.cadence_exceeded.message": "{account} 将在当天发布 {count, plural, one {# time} other {# times}}，超过 {limit} 的限制。",
