...
export const webMarketingMessages = {
  ...
  'web.marketing.provider.x': 'X',
  'web.marketing.provider.linkedin': 'LinkedIn',
  'web.marketing.provider.instagram': 'Instagram',
  'web.marketing.provider.facebook': 'Facebook',
  'web.marketing.provider.youtube': 'YouTube',
  'web.marketing.provider.tiktok': 'TikTok',
  'web.marketing.provider.threads': 'Threads',
  'web.marketing.provider.bluesky': 'Bluesky',
  ...
  'web.capabilities.summary':
    '{supported, plural, one {# capability supported} other {# capabilities supported}}, {requiresReview, plural, other {# waiting on a platform review}}, {notImplemented, plural, other {# not built yet}}, {unsupported, plural, other {# the platform does not offer}}.',
  ...
  'web.legal.subprocessors.supabase': 'Supabase',
  ...
  'web.legal.subprocessors.temporal': 'Temporal Cloud',
  ...
  'web.legal.subprocessors.polar': 'Polar',
  ...
  'web.legal.subprocessors.deepseek': 'DeepSeek',
  ...
  'web.legal.subprocessors.hosting': 'Application hosting and content delivery',
  ...
  'web.legal.subprocessors.email': 'Transactional email delivery',
  ...
  'web.legal.subprocessors.monitoring': 'Error and performance monitoring',
  ...
  'web.legal.retention.credentials': 'Active platform credentials',
  ...
  'web.legal.retention.backups': 'Backups',
