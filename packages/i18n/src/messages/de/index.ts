...
export const de = {
  ...navMessages,
  ...withoutBetaEnglishFallbacks(assistantMessages, 'de'),
  ...withoutBetaEnglishFallbacks(assistantWebMessages, 'de'),
  ...actionMessages,
  ...commonMessages,
  ...composerMessages,
  ...withoutBetaEnglishFallbacks(webComposerMessages, 'de'),
  ...calendarMessages,
  ...receiptMessages,
  ...connectionMessages,
  ...webCalendarMessages,
  ...
  ...withoutBetaEnglishFallbacks(webMarketingMessages, 'de'),
  ...webPlatformsMessages,
  ...withoutBetaEnglishFallbacks(webSettingsMessages, 'de'),
  ...webShellMessages,
  ...webToolsMessages,
  ...webUseCaseMessages,
} as const;
