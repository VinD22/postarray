export const importMessages = {
  ...
  'import.upload.pasteHelp':
    'Füge die Kopfzeile mit ein. Alles wird geprüft, bevor irgendetwas erstellt wird.',
  ...
  'import.upload.tooLarge':
    'Diese Datei ist größer als {limit} Zeichen. Teile sie und versuche es erneut.',
  ...
  'import.column.external_row_id':
    'Deine eigene ID für die Zeile. Muss innerhalb der Datei eindeutig sein.',
  ...
  'import.column.scheduled_local_time':
    'Lokales Datum und Uhrzeit, geschrieben als 2026-09-01T10:00.',
  'import.column.time_zone':
    'Die IANA-Zone, in der diese Ortszeit gelesen wird, zum Beispiel Europe/Berlin.',
  'import.column.media':
  ...
  'import.column.first_comment':
    'Text, der als erster Kommentar nach dem Beitrag veröffentlicht wird.',
  ...
  'import.results.failed':
    '{count, plural, one {# Zeile ist fehlgeschlagen} other {# Zeilen sind fehlgeschlagen}}',
  ...
  'import.error.duplicateRowId':
    'Die Zeilen-ID {value} wird in dieser Datei mehr als einmal verwendet.',
  ...
  'import.error.alreadyApplied':
    'Diese Zeile hat bereits einen Entwurf erstellt und wurde daher in Ruhe gelassen.',
