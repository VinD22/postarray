...
export const settingsMessages = {
  ...
  'settings.brands.add': 'Fügen Sie eine Marke hinzu',
  'settings.brands.voice': 'Stimme',
  'settings.brands.audience': 'Publikum',
  'settings.brands.approvedClaims': 'Genehmigte Ansprüche',
  'settings.brands.blockedTerms': 'Gesperrte Begriffe',
  'settings.brands.disclosureDefaults': 'Offenlegungsvorgaben',
  'settings.brands.domains': 'Domänen',
  'settings.brands.glossary.title': 'Glossar',
  'settings.brands.glossary.term': 'Begriff',
  'settings.brands.glossary.preferred': 'Bevorzugte Übersetzung',
  'settings.brands.glossary.prohibited': 'Nicht übersetzen als',
  'settings.brands.glossary.context': 'Kontext',
  'settings.brands.glossary.keepUntranslated': 'Unübersetzt aufbewahren',
  'settings.brands.localeRules.title': 'Lokale Regeln',
  'settings.brands.localeRules.formality': 'Formalität',
  'settings.brands.localeRules.pronouns': 'Pronomen und Ehrenbezeichnungen',
  'settings.brands.localeRules.idioms': 'Redewendungen, die man vermeiden sollte',
  'settings.brands.localeRules.emoji': 'Emoji- und Hashtag-Normen',
  'settings.brands.localeRules.legal': 'Regionale rechtliche Offenlegungen',
  'settings.brands.localeRules.cta': 'Aufruf zum Handeln nach Markt',
