...
export const mediaMessages = {
  ...
  'mediaLib.derivative.nonGenerative':
    'Post Array genereert geen afbeeldingen of video. Deze editor snijdt alleen bij, roteert, wijzigt het formaat, converteert en comprimeert wat je hebt geüpload.',
