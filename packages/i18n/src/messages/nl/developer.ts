...
export const developerMessages = {
  ...
  'developer.serviceAccount.scopeBrands': "Brand's en accounts die het kan gebruiken",
  ...
  'developer.apps.subtitle':
    'Laat een ander product via Relay werken met de machtigingen die een gebruiker eraan verleent.',
  ...
  'developer.consent.brands': "Brand's en accounts",
