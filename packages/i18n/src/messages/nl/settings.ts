...
export const settingsMessages = {
  ...
  'settings.brands.title': "Brand's",
  'settings.brands.add': 'Voeg een merk toe',
  'settings.brands.voice': 'Stem',
  'settings.brands.audience': 'Publiek',
  'settings.brands.approvedClaims': 'Goedgekeurde claims',
  'settings.brands.blockedTerms': 'Geblokkeerde termen',
  'settings.brands.disclosureDefaults': 'Standaardwaarden voor openbaarmaking',
  'settings.brands.domains': 'Domeinen',
  'settings.brands.glossary.title': 'Woordenlijst',
  'settings.brands.glossary.term': 'Termijn',
  'settings.brands.glossary.preferred': 'Voorkeur vertaling',
  'settings.brands.glossary.prohibited': 'Niet vertalen als',
  'settings.brands.glossary.context': 'Context',
  'settings.brands.glossary.keepUntranslated': 'Onvertaald houden',
  'settings.brands.localeRules.title': 'Lokale regels',
  'settings.brands.localeRules.formality': 'Formaliteit',
  'settings.brands.localeRules.pronouns': 'Voornaamwoorden en eretitels',
  'settings.brands.localeRules.idioms': 'Idioom om te vermijden',
  'settings.brands.localeRules.emoji': 'Emoji- en hashtag-normen',
  'settings.brands.localeRules.legal': 'Regionale juridische openbaarmakingen',
  'settings.brands.localeRules.cta': 'Oproep tot actie per markt',
