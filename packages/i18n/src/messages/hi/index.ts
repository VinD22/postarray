...
/** Hindi beta catalog. B5-controlled legal, billing, and consent copy falls back to reviewed English. */
export const hi = {
  ...navMessages,
  ...actionMessages,
  ...commonMessages,
  ...
  ...growthMessages,
  ...withoutBetaEnglishFallbacks(settingsMessages, 'hi'),
  ...developerMessages,
  ...digestMessages,
  ...authMessages,
  ...onboardingMessages,
  ...
  ...webDemoMessages,
  ...withoutBetaEnglishFallbacks(webMarketingMessages, 'hi'),
  ...webPlatformsMessages,
  ...withoutBetaEnglishFallbacks(webSettingsMessages, 'hi'),
  ...webShellMessages,
  ...webToolsMessages,
  ...webUseCaseMessages,
} as const;

export type HindiCatalog = typeof hi;
