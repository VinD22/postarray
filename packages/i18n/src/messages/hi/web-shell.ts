...
export const webShellMessages = {
  ...
  'shell.brand.filterHint': 'इस ब्रांड के लिए होम, कैलेंडर और एनालिटिक्स फ़िल्टर करना।',
  ...
  'onboarding.workspace.help':
    'एक कार्यक्षेत्र आपके ब्रांड, जुड़े खाते, ड्राफ्ट और रसीदें रखता है। आप बाद में और भी बना सकते हैं.',
