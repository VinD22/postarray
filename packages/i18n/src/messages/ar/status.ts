...
export const statusMessages = {
  ...
  'confirm.publishNow.body':
    '{count, plural, one {يتم النشر في حساب واحد على الفور} zero {سيتم نشر هذا في # حسابًا على الفور} two {سيتم نشر هذا في # حسابًا على الفور} few {سيتم نشر هذا في # حسابًا على الفور} many {سيتم نشر هذا في # حسابًا على الفور} other {سيتم نشر هذا في # حسابًا على الفور}}. لا يمكن استرجاعه من Relay.',
