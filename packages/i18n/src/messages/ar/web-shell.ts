...
export const webShellMessages = {
  ...
  'shell.demo.howToConnect':
    'قم بتعيين NEXT_PUBLIC_POSTARRAY_API_URL وأعد تشغيل التطبيق لاستخدام البيانات المباشرة.',
  ...
  'onboarding.workspace.help':
    'تحتوي مساحة العمل على مشاريعك وحساباتك المتصلة والمسودات والإيصالات. يمكنك إنشاء المزيد لاحقًا.',
