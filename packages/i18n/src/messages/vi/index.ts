...
/** Vietnamese beta catalog. B5-controlled copy falls back to reviewed English. */
export const vi = {
  ...navMessages,
  ...actionMessages,
  ...commonMessages,
  ...
  ...importMessages,
  ...mediaMessages,
  ...withoutBetaEnglishFallbacks(settingsMessages, 'vi'),
  ...developerMessages,
  ...emailMessages,
  ...digestMessages,
  ...authMessages,
  ...
  ...statusMessages,
  ...a11yMessages,
  ...withoutBetaEnglishFallbacks(webMarketingMessages, 'vi'),
  ...withoutBetaEnglishFallbacks(webSettingsMessages, 'vi'),
...
export type VietnameseCatalog = typeof vi;
