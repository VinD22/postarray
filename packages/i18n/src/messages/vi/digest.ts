...
export const digestMessages = {
  ...
  'digest.empty':
    'Chưa có gì để tóm tắt cho tuần này. Hãy đăng một nội dung và nội dung đó sẽ xuất hiện ở đây.',
  'digest.regenerate': 'Tạo lại tuần này',
  'digest.generating': 'Đang tạo bản tóm tắt tuần này',
  'digest.source.deterministic':
    'Được viết từ hồ sơ đăng bài và các phép đo của bạn, không dùng trợ lý viết.',
  'digest.source.ai':
    'Được trợ lý viết từ hồ sơ của bạn. Mọi con số đều đã được đối chiếu với hồ sơ đó.',
  'digest.unavailable.aiOff':
    'Trợ lý viết đang tắt nên đây là phiên bản cơ bản. Không có gì bị thiếu.',
  'digest.unavailable.rejected':
    'Phiên bản của trợ lý không khớp với dữ liệu nên đã bị loại bỏ. Đây là phiên bản cơ bản.',
  ...
  'digest.headline.nothingPublished':
    'Không có nội dung nào được đăng từ {windowStart} đến {windowEnd}.',
  ...
  'digest.metrics.noneYet':
    'Chưa có phép đo nào cho tuần này. Điều đó có nghĩa là chúng tôi chưa biết các bài đăng hoạt động ra sao, không phải chúng hoạt động kém.',
  ...
  'digest.settings.description':
    'Một email ngắn mỗi tuần về những gì đã đăng và những gì chúng tôi đo được. Bật theo mặc định.',
