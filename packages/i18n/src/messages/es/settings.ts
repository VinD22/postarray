...
export const settingsMessages = {
  ...
  'settings.brands.add': 'Agregar una marca',
  'settings.brands.voice': 'Voz',
  'settings.brands.audience': 'Audiencia',
  'settings.brands.approvedClaims': 'Reclamaciones aprobadas',
  'settings.brands.blockedTerms': 'Términos bloqueados',
  'settings.brands.disclosureDefaults': 'Valores predeterminados de divulgación',
  'settings.brands.domains': 'Dominios',
  'settings.brands.glossary.title': 'Glosario',
  'settings.brands.glossary.term': 'Término',
  'settings.brands.glossary.preferred': 'Traducción preferida',
  'settings.brands.glossary.prohibited': 'No traducir como',
  'settings.brands.glossary.context': 'Contexto',
  'settings.brands.glossary.keepUntranslated': 'Mantener sin traducir',
  'settings.brands.localeRules.title': 'Reglas locales',
  'settings.brands.localeRules.formality': 'Formalidad',
  'settings.brands.localeRules.pronouns': 'Pronombres y honoríficos',
  'settings.brands.localeRules.idioms': 'Modismos a evitar',
  'settings.brands.localeRules.emoji': 'Normas de emojis y hashtags',
  'settings.brands.localeRules.legal': 'Divulgaciones legales regionales',
  'settings.brands.localeRules.cta': 'Llamado a la acción por mercado',
  'settings.brands.localeRules.reviewedExamples': 'Ejemplos aprobados por un revisor nativo',
