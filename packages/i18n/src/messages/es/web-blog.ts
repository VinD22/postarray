export const webBlogMessages = {
  'web.blog.meta.title': 'Textos sobre operaciones de publicación',
  ...
  'web.blog.title': 'Textos',
  'web.blog.lede':
    'Notas sobre la mecánica del trabajo de publicación: cómo se dimensiona un cronograma, cómo se comporta una cola cuando una semana se descarrila, qué cambia de verdad entre plataformas, y cómo se mantiene separado el trabajo de clientes.',
  ...
  'web.blog.notice.prelaunch.body':
    'Ningún conector aquí completó la verificación del proveedor, así que no se publica nada en ninguna plataforma a través de este producto hoy. Toda regla de plataforma de abajo trae el documento oficial del que vino y la fecha en que una persona lo leyó.',
  ...
  'web.blog.label.count':
    '{count, plural, =0 {Todavía no hay artículos} one {# artículo} many {# artículos} other {# artículos}}',
  ...
  'web.blog.feed.title': 'Textos sobre operaciones de publicación',
  'web.blog.feed.description':
    'Artículos nuevos sobre el ritmo de publicación, modelos de programación, zonas horarias, adaptación por plataforma y operaciones de agencia.',
  'web.blog.feed.label': 'Feed RSS',

  'web.blog.empty.title': 'Todavía no hay nada publicado aquí',
  'web.blog.empty.body':
    'Los primeros artículos se están escribiendo. El feed los traerá en cuanto estén publicados.',

  'web.blog.label.language': 'Leer en',
  'web.blog.label.notTranslated':
    'Este artículo todavía no está escrito en tu idioma. Mostrando la versión en inglés.',
  'web.blog.label.languageCount':
    '{count, plural, one {# idioma} many {# idiomas} other {# idiomas}}',
} as const;
