...
export const errorMessages = {
  ...
  'error.not_implemented.message': 'Post Array aún no ha construido esto.',
  ...
  'error.insufficient_scope.message': 'Esta credencial no tiene el scope {scope}.',
  ...
  'error.rate_limited.action': 'Inténtalo de nuevo after {time}.',
  'error.quota_exceeded.message': 'Esta acción supera el límite del período actual.',
  'error.quota_exceeded.action': 'El límite resets {relativeTime}.',
  ...
  'error.trial_expired.message': 'El juicio terminó el on {date}.',
  'error.trial_expired.action': 'Inicia la suscripción para continuar publicando.',
  'error.post_credits_exhausted.message':
    'Este espacio de trabajo ha usado todas sus publicaciones gratuitas. Todo lo demás sigue funcionando.',
  ...
  'error.channel_limit_reached.message':
    'Este espacio de trabajo ya utiliza all {limit} canales activos.',
  ...
  'error.connection_revoked.message': '{account} acceso revocado on {provider}.',
  'error.connection_revoked.action':
    'Vuelva a conectar la cuenta. Las publicaciones programadas se reanudan después de eso.',
  'error.connection_expired.message': 'El acceso for {account} expiró.',
  ...
  'error.connection_permission_missing.message':
    '{account} no ha otorgado el permiso necesario para hacer esto.',
  'error.connection_permission_missing.action':
    'Vuelva a conectarse y accept {permission} en la pantalla de consentimiento.',
  ...
  'error.connection_account_type_invalid.action':
    'Cambie a una cuenta comercial o de creador en la aplicación Instagram y luego vuelva a conectarse.',
  'error.connection_review_pending.message':
    '{provider} todavía está revisando esta aplicación for {account}.',
  ...
  'error.capability_not_implemented.message': 'Post Array aún no ha construido este for {provider}.',
  ...
  'error.content_invalid.message': '{provider} no aceptará este contenido for {account}.',
  ...
  'error.duplicate_content.message':
    'Se publicó contenido muy similar el to {account} {relativeTime}.',
  ...
  'error.media_invalid.message': 'Este archivo no se puede publicar to {provider}.',
  'error.media_invalid.action': 'El límite exacto se muestra al lado del archivo.',
  'error.media_too_large.message': 'Este archivo es más grande than {provider} acepta.',
  'error.media_too_large.action':
    'Comprímelo o sube una versión más pequeña. Se conserva el original.',
  'error.media_processing_failed.message': 'No pudimos preparar este archivo for {provider}.',
  ...
  'error.alt_text_required.message': 'Esta imagen necesita texto alternativo for {provider}.',
  ...
  'error.approval_required.action': 'Solicitar aprobación from {approver}.',
  'error.approval_expired.message': 'La aprobación para esta publicación expiró el on {date}.',
  'error.approval_expired.action': 'Solicite aprobación nuevamente.',
  'error.schedule_in_past.message': 'Ese tiempo ya pasó in {timeZone}.',
  'error.schedule_in_past.action': 'Elija un momento posterior o publíquelo ahora.',
  'error.schedule_conflict.message':
    '{account} ya tiene una publicación within {duration} de esta vez.',
  'error.schedule_conflict.action': 'Mueva uno de ellos o continúe si se desea ese espacio.',
  'error.time_zone_invalid.message': 'No reconocemos la hora zone {timeZone}.',
  'error.time_zone_invalid.action': 'Elija una zona de la lista.',
  'error.destination_unavailable.message':
    'El destination {destination} ya no está disponible on {provider}.',
  'error.destination_unavailable.action': 'Actualiza la lista de destinos y elige otro.',
  'error.mention_unresolved.message':
    'Una mención no se ha asociado con una cuenta real {provider}.',
  ...
  'error.provider_transient.message': '{provider} no pudo procesar esto en este momento.',
  ...
  'error.provider_rate_limited.message': '{provider} tarifa limitó este espacio de trabajo.',
  'error.provider_rate_limited.action': 'Volveremos a intentar after {time}.',
  ...
  'error.provider_content_rejected.message':
    '{provider} rechazó este contenido según sus propias políticas.',
  'error.provider_content_rejected.action':
    'El motivo que dio está en el recibo. Editar el contenido o apelar with {provider}.',
  ...
  'error.short_link_domain_unverified.message': 'El domain {domain} aún no está verificado.',
  ...
  'error.webhook_delivery_failed.message': 'La entrega to {endpoint} falló.',
  ...
  'error.ai_budget_exceeded.action':
    'El límite resets {relativeTime}. Escribir a mano todavía funciona.',
  ...
  'error.project_limit_reached.action':
    'Archiva un proyecto inactivo o cambia la asignación de proyectos del espacio de trabajo.',
  'error.project_has_connections.message':
    'Este proyecto todavía tiene {connected, plural, one {# canal conectado} many {# canales conectados} other {# canales conectados}}.',
  'error.project_has_connections.action':
    'Desconecta todos los canales de este proyecto antes de archivarlo.',
  'error.project_last_active.message':
    'Un espacio de trabajo debe mantener al menos un proyecto activo.',
  'error.project_last_active.action': 'Crea otro proyecto antes de archivar este.',
} as const;
