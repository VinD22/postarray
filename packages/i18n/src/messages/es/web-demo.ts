export const webDemoMessages = {
  ...
  'web.demo.lede':
    'Seis pasos, desde un workspace vacío hasta el registro de lo que ocurrió. Cada uno muestra la superficie que realmente estarías viendo, con contenido de ejemplo en ella.',
