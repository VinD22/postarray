...
export const webPlatformsMessages = {
  ...
  'web.schedule.unit.utf16': 'นับเป็นหน่วยรหัส UTF-16 ซึ่งเป็นวิธีที่ตัวแก้ไขข้อความส่วนใหญ่รายงานจำนวนตัวอักษร',
  'web.schedule.unit.grapheme': 'นับเป็นกราฟีม ดังนั้นอิโมจิที่ประกอบด้วยหลายจุดรหัสจึงยังคงนับเป็นหนึ่งตัวอักษร',
  ...
  'web.specs.detail.siblingBody': 'ค่าอื่น ๆ ในชุดข้อมูลที่สร้างขึ้นเดียวกัน มีแหล่งที่มาแบบเดียวกัน',
