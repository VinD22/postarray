...
export const postingSetMessages = {
  ...
  'calendar.hold.byBilling':
    'หยุดชั่วคราวเมื่อ {date} เพราะพื้นที่ทำงานนี้สูญเสียสิทธิ์การเข้าถึงเต็มรูปแบบ',
  ...
  'calendar.hold.confirmNoteHint':
    'เก็บไว้ในบันทึกการตรวจสอบสำหรับทีมของคุณ ไม่ถูกส่งไปยังแพลตฟอร์มใด',
  ...
  'set.archivedNote':
    'ชุดที่เก็บเข้าคลังจะถูกซ่อนจากตัวเลือก โพสต์ที่สร้างจากชุดเหล่านั้นไม่เปลี่ยนแปลง',
  ...
  'set.slot.noRules': 'โปรเจกต์นี้ยังไม่มีกฎของคิว คิวจะเสนอชั่วโมงว่างแรกและจะแจ้งให้ทราบเช่นนั้น',
  'set.slot.rulesLink': 'กฎของคิว',

  'set.defaults.title': 'ค่าเริ่มต้นตามแต่ละแพลตฟอร์ม',
  'set.defaults.body':
    'ค่าตั้งต้นที่ถูกคัดลอกลงในโพสต์ใหม่แต่ละรายการ คุณเปลี่ยนค่าใด ๆ ในตัวเขียนโพสต์ภายหลังได้',
