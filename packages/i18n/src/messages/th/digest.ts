...
export const digestMessages = {
  ...
  'digest.source.deterministic':
    'เขียนจากบันทึกการเผยแพร่และการวัดผลของคุณเอง โดยไม่ใช้ผู้ช่วยเขียน',
  'digest.source.ai':
    'ผู้ช่วยเขียนจากบันทึกของคุณเอง ตัวเลขทุกตัวผ่านการตรวจสอบกับบันทึกเหล่านั้นแล้ว',
  'digest.unavailable.aiOff': 'ผู้ช่วยเขียนปิดอยู่ จึงแสดงเวอร์ชันปกติ ไม่มีข้อมูลใดหายไป',
  'digest.unavailable.rejected':
    'เวอร์ชันจากผู้ช่วยไม่ตรงกับข้อมูลของคุณ จึงถูกทิ้ง และแสดงเวอร์ชันปกติแทน',
  ...
  'digest.metrics.noneYet':
    'ยังไม่มีข้อมูลการวัดผลสำหรับสัปดาห์นี้ นั่นหมายความว่าเรายังไม่รู้ว่าโพสต์ทำผลงานอย่างไร ไม่ได้หมายความว่าผลงานแย่',
  ...
  'digest.settings.description':
    'อีเมลสั้น ๆ ทุกสัปดาห์เกี่ยวกับสิ่งที่เผยแพร่และสิ่งที่เราวัดผลได้ เปิดใช้งานเป็นค่าเริ่มต้น',
