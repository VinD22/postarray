...
export const settingsMessages = {
  ...
  'settings.members.inviteSent': 'Invitación enviada a {email}.',
  'settings.members.pending': 'Invitado, aún no aceptado',
  'settings.members.count': '{count, plural, one {#miembro} other {#miembros} many {#miembros}}',
  'settings.members.removeConfirm':
    'Quitar {name}de este espacio de trabajo? Sus acciones pasadas permanecen en el registro de auditoría.',
