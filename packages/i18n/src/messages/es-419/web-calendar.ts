...
export const webCalendarMessages = {
  ...
  'web.calendar.range.label': 'Mostrando {range}en {timeZone}',
  ...
  'web.calendar.filter.summary':
    '{count, plural, =0 {Sin filtros} one {#filtrar} other {#filtros} many {#filtros}}, {results, plural, =0 {sin publicaciones} one {#publicar} other {#publicaciones} many {#publicaciones}}',
  'web.calendar.grid.label': 'Cuadrícula de horarios para {range}',
  'web.calendar.grid.hourLabel': '{time}',
  'web.calendar.grid.emptySlot': 'Nada en {time}en {date}',
  'web.calendar.grid.dayColumn': '{weekday} {day}',
  'web.calendar.grid.overflow':
    '{count, plural, one {Mostrar #más publicaciones} other {Mostrar #más publicaciones} many {Mostrar #más publicaciones}}',
  'web.calendar.month.label': 'Cuadrícula mensual para {month}',
  ...
  'web.calendar.table.caption': 'Cada publicación en {range}, ordenados por hora de publicación.',
  ...
  'web.calendar.table.rowMenu': 'Acciones para {title}',
  ...
  'web.calendar.entry.openDetail': 'Abierto {title}',
  ...
  'web.calendar.keyboard.grabbed':
    '{title}recogido de {from}. Las teclas de flecha lo mueven. Entrar confirma. La fuga se cancela.',
  'web.calendar.keyboard.moved': 'tiempo propuesto{to}. Entrar confirma.',
  'web.calendar.keyboard.released': '{title}poner de nuevo en {from}.',
  'web.calendar.keyboard.stepMinutes': 'Cada paso es {minutes}minutos.',
  'web.calendar.reschedule.title': '¿Mover esta publicación?',
  'web.calendar.reschedule.subject': '{account}en {provider}',
  ...
  'web.calendar.reschedule.dstBody':
    'La compensación en {timeZone}es {fromOffset}en los viejos tiempos y {toOffset}en el nuevo tiempo. La hora local que usted eligió se mantiene, por lo que el instante UTC cambia.',
  ...
  'web.calendar.reschedule.conflictBody':
    '{account}ya tiene {count, plural, one {#publicar} other {#publicaciones} many {#publicaciones}}dentro {window}del nuevo tiempo.',
  'web.calendar.reschedule.campaignTitle': 'Conflicto de campaña',
  'web.calendar.reschedule.campaignBody':
    'Campaña {campaign}corre de {start}a {end}. La nueva hora está fuera de esa ventana.',
  'web.calendar.reschedule.leadTimeTitle': 'esto es muy pronto',
  'web.calendar.reschedule.leadTimeBody':
    'El nuevo tiempo es {duration}desde ahora. {provider}necesidades {required}para preparar los medios para este tipo de publicación.',
  ...
  'web.calendar.published.optionNewHint':
    'Esto crea una segunda publicación externa separada. El que ya esta en {provider}permanece en línea.',
  'web.calendar.published.optionLabel': '¿Qué debería pasar?',
  'web.calendar.attention.title':
    '{count, plural, one {#la publicación necesita una decisión o una solución} other {#las publicaciones necesitan una decisión o una solución} many {#las publicaciones necesitan una decisión o una solución}}',
  ...
  'web.calendar.emptyFiltered.body':
    'No hay publicaciones en {range}coincide con estos filtros. Amplíe el rango o borre un filtro.',
  ...
  'web.calendar.rateLimited.resetUnknown': '{provider}No dije cuándo se reinicia esto.',
  ...
  'web.receipt.item.comment': 'Comentario {position}',
  'web.receipt.item.thread': 'Parte del hilo {position}',
  'web.receipt.item.delay': 'Corre {delay}después de la publicación raíz',
  ...
  'web.receipt.attempt.heading': 'intento {number}',
  ...
  'web.receipt.attempt.duration': 'tomó {duration}',
  ...
  'web.receipt.attempt.nextRetry': 'Próximo intento de {time}',
  ...
  'web.receipt.cost.currency': 'cargado en {currency}',
  ...
  'web.receipt.export.denied':
    'Para compartir un recibo se necesita el rol de propietario, administrador o aprobador. tu eres {role}.',
  ...
  'web.connection.row.expand': 'Mostrar el resumen completo de {account}',
  'web.connection.row.collapse': 'Ocultar el resumen completo de {account}',
  'web.connection.row.metered': 'Medido por operación. Estimado {amount}por publicación creada.',
  ...
  'web.connection.health.expiresIn': 'El acceso caduca {relativeTime}, en {date}',
  'web.connection.health.noExpiry': 'Este acceso no caduca según un cronograma {provider}nos dice.',
  'web.connection.health.checkedAt': 'Salud revisada {relativeTime}',
  ...
  'web.connection.action.menu': 'Otras acciones para {account}',
  'web.connection.pause.title': 'Pausa {account}?',
  'web.connection.resume.title': 'Currículum {account}?',
  ...
  'web.connection.capability.version': 'Versión de definiciones de conectores {version}',
  'web.connection.capability.observedAt': 'Lectura instantánea {relativeTime}',
  ...
  'web.connection.capability.cellLabel': '{feature}en {provider}: {state}',
  ...
  'web.connection.group.movedAnnouncement': '{account}se mudó a {group}',
  ...
  'web.connection.incident.scheduledOnHold':
    '{count, plural, one {#la publicación programada está en espera} other {#las publicaciones programadas están en espera} many {#las publicaciones programadas están en espera}}para esta cuenta.',
