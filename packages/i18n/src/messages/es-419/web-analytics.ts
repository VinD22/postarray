...
export const webAnalyticsMessages = {
  ...
  'analytics.filter.project': 'Proyecto',
  ...
  'analytics.evidence.confounder.paid':
    'Post Array no puede decir si alguna de estas publicaciones recibió distribución paga.',
  ...
  'analytics.unit.ratio': 'Una relación Post Array calculada a partir de dos campos de proveedor',
  ...
  'analytics.value.unavailableReason.notImplemented':
    'Post Array no ha creado la asignación para esta métrica el {provider}todavía.',
  ...
  'analytics.links.emptyBody':
    'Un enlace rastreado es una URL corta a la que Post Array redirecciona, por lo que puede ver los clics incluso cuando una plataforma no informa ninguno. El destino original nunca se cambia sin una entrada de auditoría.',
  ...
  'analytics.links.compareWarning':
    '{provider}informes {providerValue}Clics en el enlace para esta publicación. Post Array grabado {relayValue}clics deduplicados. Los dos cuentan eventos diferentes y ninguno reemplaza al otro.',
  ...
  'automation.param.project': 'Proyecto',
  ...
  'automation.rss.emptyBody':
    'Agregue un feed y Post Array lo verifica según un cronograma. Cada elemento nuevo se convierte en un borrador, una publicación programada o una solicitud de aprobación, lo que elijas.',
  ...
  'automation.rss.deleteBody':
    'Post Array deja de verificar este feed. Los borradores y publicaciones que ya creó permanecen exactamente como están.',
  'automation.rss.errorTitle': 'Este feed no se pudo leer.',
  'automation.rss.errorBody':
    'Post Array sigue comprobando según el horario normal. No se publicó nada a partir de una respuesta parcial.',
