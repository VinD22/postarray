export const webToolsMessages = {
  ...
  'web.meta.tools.description':
    'Herramientas pequeñas y privadas para quienes publican en varias plataformas: una verificación de límite por plataforma, un generador de UTM, una verificación de longitud de título de YouTube y un planificador de zona horaria.',
  'web.meta.tools.preflight.title': 'Verificador de publicación previa',
  ...
  'web.meta.tools.utm.title': 'Generador de enlaces UTM',
  'web.meta.tools.utm.description':
    'Arma una URL de campaña etiquetada y mira qué significa cada parámetro UTM. Funciona por completo en tu navegador.',
  ...
  'web.meta.tools.timeZone.description':
    'Mira un horario de publicación en varias zonas horarias de audiencia y encuentra las semanas en las que un cambio de horario de verano mueve la hora local.',
  'web.meta.tools.engagementRate.title': 'Calculadora de tasa de interacción',
  'web.meta.tools.engagementRate.description':
    'Divide interacciones entre alcance, seguidores o impresiones. Tres cálculos simples, sin referencia inventada.',
  ...
  'web.tools.index.summary':
    'Calculadoras pequeñas construidas sobre los mismos datos de límite de plataforma que leen nuestros conectores.',
  'web.tools.index.lede':
    'Cuatro herramientas pequeñas, construidas sobre los mismos datos de límite de plataforma que usan nuestros conectores. Sin cuenta, sin subir archivos, sin rastrear lo que escribes.',
  ...
  'web.tools.shared.privacyBody':
    'Todo lo que escribes se queda en esta página. No hay solicitud a un servidor, ningún almacenamiento y ningún evento de analítica que registre tu texto.',
  ...
  'web.tools.shared.faqTitle': 'Preguntas frecuentes',
  'web.tools.shared.baselineTitle': 'Qué tipo de cuenta describen estos números',
  ...
  'web.tools.preflight.name': 'Verificador de publicación previa',
  'web.tools.preflight.summary':
    'Un borrador, verificado contra los límites de texto y medios de diez plataformas a la vez.',
  'web.tools.utm.name': 'Generador de enlaces UTM',
  'web.tools.utm.summary': 'Arma una URL de campaña etiquetada sin dañar la query string que ya traía.',
  'web.tools.youtubeTitle.name': 'Verificador de longitud de título de YouTube',
  'web.tools.youtubeTitle.summary': 'Mide un título tal como lo cuenta una persona.',
  'web.tools.timeZone.name': 'Planificador de zona horaria y horario de verano',
  'web.tools.timeZone.summary':
    'Un horario de publicación en varias zonas horarias de audiencia, con los cambios de horario de verano marcados.',
  'web.tools.engagementRate.name': 'Calculadora de tasa de interacción',
  'web.tools.engagementRate.summary':
    'Interacciones divididas entre alcance, seguidores o impresiones. Nada se consulta, nada se usa como referencia.',

  /* ---------------------------------------------------------------------- */
  /* Verificador de publicación previa                                     */
  /* ---------------------------------------------------------------------- */

  'web.tools.preflight.title': 'Verificador de publicación previa',
  ...
  'web.tools.preflight.field.platforms.help': 'Elige todas las que uses para publicar.',
  ...
  'web.tools.preflight.field.byteSize.help': 'El archivo único más grande. Déjalo vacío para omitirlo.',
  'web.tools.preflight.field.duration.label': 'Duración del video en segundos',
  'web.tools.preflight.field.duration.help': 'Déjalo vacío para omitir la verificación de duración.',
  'web.tools.preflight.field.width.label': 'Ancho del archivo en píxeles',
  'web.tools.preflight.field.height.label': 'Alto del archivo en píxeles',
  ...
  'web.tools.preflight.results.summary':
    '{fail, plural, =0 {Nada bloquea} other {# fallarían}}, {warning, plural, =0 {sin avisos} other {# para revisar}}.',
  ...
  'web.tools.preflight.finding.textOver':
    'Se pasa del límite en {over, plural, one {# carácter} many {# caracteres} other {# caracteres}}.',
  ...
  'web.tools.preflight.finding.altText':
    'El texto alternativo se acepta hasta {limit} caracteres, y vale la pena usarlo.',
  'web.tools.preflight.finding.ratio': 'Estarías publicando en aproximadamente {ratio} a 1.',
  'web.tools.preflight.faq.counting.q': '¿Cómo se cuentan los caracteres?',
  'web.tools.preflight.faq.counting.a':
    'Por grafema, usando el segmentador Intl del navegador, que es la unidad que un lector entiende como carácter. Donde una plataforma documenta una regla diferente, como contar unidades de código o cobrar un ancho fijo por enlace, esa regla se aplica encima.',
  'web.tools.preflight.faq.accuracy.q': '¿Qué tan actuales son estos límites?',
  'web.tools.preflight.faq.accuracy.a':
    'Cada límite se genera a partir del código de conectores de nuestro repositorio en lugar de escribirse aparte en una página, y cada fila de plataforma muestra el documento oficial del que vino y la fecha en que una persona lo leyó. Si una plataforma cambia un número, la corrección es un cambio de código y toda herramienta aquí lo sigue.',
  'web.tools.preflight.faq.privacy.q': '¿Se sube mi borrador a algún lugar?',
  'web.tools.preflight.faq.privacy.a':
    'No. La verificación se ejecuta en tu navegador. No hay solicitud que lleve tu texto, nada se guarda, y con cerrar la pestaña basta para descartarlo.',
  ...
  'web.tools.utm.title': 'Generador de enlaces UTM',
  'web.tools.utm.lede':
    'Agrega parámetros de campaña a una URL sin perder la query string que ya traía, y sin adivinar qué significa cada parámetro.',
  'web.tools.utm.explainer.title': 'Para qué sirve cada parámetro',
  'web.tools.utm.explainer.body':
    'Los parámetros UTM los leen las herramientas de analítica, no la plataforma en la que publicas. Viajan en la URL, así que cualquiera que vea el enlace los ve. Mantenlos cortos, en minúsculas y consistentes, porque dos formas de escribir la misma campaña se convierten en dos filas en un informe.',
  ...
  'web.tools.utm.field.url.invalid': 'Eso no se reconoce como una URL http o https.',
  ...
  'web.tools.utm.field.medium.help': 'El tipo de enlace. Por ejemplo, social, correo o referido.',
  ...
  'web.tools.utm.field.content.help':
    'Opcional. Diferencia dos enlaces a la misma página, por ejemplo dos versiones de una publicación.',
  'web.tools.utm.result.title': 'Tu URL etiquetada',
  'web.tools.utm.result.empty': 'Escribe una URL de destino para ver el resultado.',
  'web.tools.utm.result.label': 'URL final',
  'web.tools.utm.result.preserved':
    'La query string que ya traía tu URL se mantiene exactamente como la escribiste.',
  ...
  'web.tools.utm.faq.encoding.a':
    'Se codifican en porcentaje, que es lo que permite que un enlace sobreviva al pegarlo en una publicación. Un espacio se convierte en un signo más y una letra acentuada se convierte en su forma codificada, y las herramientas de analítica decodifican ambas de vuelta.',
  'web.tools.utm.faq.existing.q': '¿Esto va a dañar una URL que ya tiene parámetros?',
  'web.tools.utm.faq.existing.a':
    'No. Los parámetros existentes se conservan en su orden original, y solo se agrega o reemplaza el parámetro UTM que hayas completado. Un fragmento al final de la URL se queda al final.',
  'web.tools.utm.faq.privacy.q': '¿Se envía mi URL a algún lugar?',
  'web.tools.utm.faq.privacy.a': 'No. La URL se arma en tu navegador y nunca sale de esta página.',
  ...
  'web.tools.youtubeTitle.explainer.title': 'Dos límites distintos',
  'web.tools.youtubeTitle.explainer.body':
    'El tope duro es lo que acepta el punto de subida. Dónde se muestra un título es una pregunta aparte: un resultado de búsqueda, una barra lateral y un teléfono cortan un título en un punto diferente, y ninguno de esos puntos de corte se publica. Esta herramienta aplica el tope documentado y muestra la forma de tu título, sin inventar un número de corte.',
  ...
  'web.tools.youtubeTitle.result.over':
    'Se pasa en {over, plural, one {# carácter} many {# caracteres} other {# caracteres}}. La subida se rechazaría.',
  'web.tools.youtubeTitle.result.fits': 'Dentro del tope documentado.',
  'web.tools.youtubeTitle.result.front':
    'Los primeros {count} caracteres pesan más, porque es aproximadamente lo que cabe en un diseño angosto. El tuyo empieza así: {preview}',
  ...
  'web.tools.youtubeTitle.faq.truncation.q': '¿En qué punto exacto corta YouTube un título?',
  'web.tools.youtubeTitle.faq.truncation.a':
    'Depende de la superficie y del viewport, y YouTube no publica un conteo de caracteres para eso. Mostramos el tope, que sí está documentado, y no imprimimos un número de corte que sería una suposición.',
  'web.tools.youtubeTitle.faq.emoji.q': '¿Un emoji cuenta como un carácter?',
  'web.tools.youtubeTitle.faq.emoji.a':
    'En este contador sí, porque contamos grafemas. Una plataforma que cuenta unidades de código internamente puede cobrar más por el mismo emoji, y por eso el verificador de publicación previa aplica la regla de cada plataforma por separado.',
  ...
  'web.tools.timeZone.field.audience.label': 'Zonas horarias de audiencia',
  ...
  'web.tools.timeZone.result.empty': 'Elige al menos una zona horaria de audiencia.',
  ...
  'web.tools.engagementRate.faq.formula.a':
    'Interacciones divididas entre el denominador que elijas, mostradas como porcentaje. Interacciones aquí significa me gusta, comentarios, veces compartida y guardados sumados; algunas plataformas los reportan por separado, en cuyo caso súmalos tú mismo antes de escribir el total.',
