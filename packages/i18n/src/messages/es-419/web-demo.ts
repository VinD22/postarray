export const webDemoMessages = {
  ...
  'web.demo.control.replay': 'Reproducir la demostración de nuevo',
  ...
  'web.demo.hero.projectsLine':
    'Una cuenta administra varios negocios. Cada proyecto es su propio negocio, con sus propias cuentas conectadas, su propio calendario y sus propias aprobaciones, y cambias entre ellos desde un solo menú, como cambias de propiedad en una consola de búsqueda.',
  ...
  'web.demo.accounts.note':
    'Cada fila mostraría el estado del token, los permisos otorgados y la última publicación enviada con éxito. Ninguna puede publicar hoy.',
  ...
  'web.demo.sample.master':
    'Northbound 2.4 ya salió hoy. Las importaciones son más rápidas, la búsqueda tiene un atajo de teclado, y el error de exportación que dos de ustedes reportaron ya está corregido.',

  'web.demo.sample.x.account': 'X, @northbound',
  'web.demo.sample.x.body':
    'Northbound 2.4 ya salió. Importaciones más rápidas, búsqueda por teclado, y ese error de exportación ya está corregido.',
