export const webUseCaseMessages = {
  ...
  'web.meta.useCases.description':
    'Tres flujos de trabajo para los que se está construyendo este producto: administrar varios clientes en un solo lugar, lograr que el trabajo se apruebe antes de salir, y llevar una idea a varias plataformas sin reescribirla.',
  ...
  'web.useCases.index.lede':
    'Tres flujos de trabajo para los que se está construyendo este producto. Cada página dice qué le cuesta a un equipo hoy ese flujo, cómo está diseñado el producto para manejarlo, y qué partes ya están construidas de verdad.',
  ...
  'web.useCases.clients.problem':
    'La mayoría de los equipos separan a los clientes con cuidado. Una cuenta compartida guarda toda página conectada, un calendario guarda toda programación, y lo único que separa el borrador de un cliente de la audiencia equivocada es la persona mirando la pantalla a las 6 de la tarde. Cuando alguien deja el equipo, la separación se va con el hábito.',
  ...
  'web.useCases.clients.today':
    'Los proyectos, la membresía restringida a proyecto y las políticas de seguridad a nivel de fila detrás de ellas están construidos y probados, incluyendo pruebas que intentan lecturas entre proyectos y verifican que fallen. Los planes se dimensionan según cuántos proyectos necesita un equipo. Todavía no se publica nada en ninguna plataforma desde ningún proyecto.',
  ...
  'web.useCases.crossPlatform.problem':
    'Publicar el mismo texto en todas partes produce una versión que se corta en una plataforma, sin un título obligatorio en otra, y con un enlace que una tercera elimina en silencio. La alternativa, reescribir a mano cinco veces, es a donde realmente termina yendo el trabajo.',
  'web.useCases.crossPlatform.approach1':
    'Un borrador maestro guarda la idea. Cada cuenta seleccionada obtiene su propia versión, y una edición al maestro se aplica solo donde cabe, indicando con claridad qué destinos no pudieron recibirla y por qué.',
