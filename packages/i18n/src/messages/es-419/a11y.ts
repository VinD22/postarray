...
export const a11yMessages = {
  ...
  'a11y.announce.validationCount':
    '{count, plural, =0 {Sin problemas de validación} one {#problema de validación} other {#problemas de validación} many {#problemas de validación}}',
  'a11y.announce.validationCleared': 'Todos los problemas de validación resueltos',
  'a11y.announce.targetSelected':
    '{account}seleccionado. {count, plural, one {#objetivo} other {#objetivos} many {#objetivos}}en total.',
  ...
  'a11y.announce.uploadFailed': '{name}no se pudo cargar',
  'a11y.announce.scheduled': 'Programado para {time}en {timeZone}',
  'a11y.announce.rescheduled': 'Se mudó a {time}en {timeZone}',
  'a11y.announce.publishing': 'Publicación',
  'a11y.announce.published':
    '{count, plural, one {Publicado en #cuenta} other {Publicado en #cuentas} many {Publicado en #cuentas}}',
  'a11y.announce.publishPartial':
    'Publicado en {published}de {total}cuentas. {failed, plural, one {#la cuenta necesita atencion} other {#las cuentas necesitan atención} many {#las cuentas necesitan atención}}.',
  'a11y.announce.publishFailed': 'La publicación falló. Su contenido se conserva.',
  'a11y.announce.approvalRequested': 'Aprobación solicitada de {approver}',
  ...
  'a11y.announce.filterApplied':
    '{count, plural, =0 {Filtros borrados} one {#filtro aplicado} other {#filtros aplicados} many {#filtros aplicados}}, {results, plural, one {#resultado} other {#resultados} many {#resultados}}',
  ...
  'a11y.label.sortBy': 'Ordenar por {field}',
  'a11y.label.sortAscending': 'Ordenado ascendente',
  'a11y.label.sortDescending': 'Ordenado descendente',
  'a11y.label.removeTarget': 'Quitar {account}de los objetivos',
  'a11y.label.removeMedia': 'Quitar {name}',
  'a11y.label.editAltText': 'Editar texto alternativo para {name}',
  'a11y.label.mediaPreview': 'Vista previa de {name}',
  'a11y.label.playVideo': 'Jugar {name}',
  'a11y.label.pauseVideo': 'Pausa {name}',
  'a11y.label.calendarCell':
    '{date}, {count, plural, =0 {nada programado} one {#publicar} other {#publicaciones} many {#publicaciones}}',
  'a11y.label.postSummary': '{account}en {provider}, {state}, {time}',
  'a11y.label.characterCount': '{used}de {limit}personajes utilizados',
  ...
  'a11y.label.expandRow': 'Mostrar detalles para {name}',
  'a11y.label.collapseRow': 'Ocultar detalles para {name}',
  'a11y.languagePicker.label': 'Elija el idioma de la interfaz',
  'a11y.languagePicker.filterLabel': 'Filtrar idiomas',
  'a11y.languagePicker.announceChanged': 'El idioma de la interfaz cambió a {language}',
