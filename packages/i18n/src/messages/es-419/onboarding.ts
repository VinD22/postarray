...
export const onboardingMessages = {
  ...
  'onboarding.plan.title': 'Elige cómo quieres pagar',
  'onboarding.plan.help': 'Un plan, todas las funciones. Cambia el intervalo cuando quieras.',
  ...
  'onboarding.done.body': 'Tu publicación está programada para {time}en {timeZone}.',
  ...
  'onboarding.checklist.setProjectVoice': 'Describe la voz de tu proyecto',
  'onboarding.checklist.tryAutomation': 'Pruebe una regla de automatización',
  'onboarding.checklist.remaining':
    '{count, plural, =0 {todo hecho} one {#paso a la izquierda} other {#pasos a la izquierda} many {#pasos a la izquierda}}',
} as const;
