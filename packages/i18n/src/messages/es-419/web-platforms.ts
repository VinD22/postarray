export const webPlatformsMessages = {
  ...
  'web.schedule.index.lede':
    'Una página por plataforma en el grupo de lanzamiento. Cada una indica lo que la plataforma pide de una cuenta conectada, los límites que aplica su API oficial, y en qué punto va la construcción. Todo número trae el documento del que vino y la fecha en que una persona lo leyó.',
  ...
  'web.schedule.limits.lede':
    'Leídos para una cuenta recién conectada sin elegibilidad elevada. Una plataforma puede subir o bajar cualquiera de estos sin avisarle a nadie, y por eso cada conjunto trae la fecha en que se leyó.',
  ...
  'web.schedule.value.markdownNo': 'Publicado como texto simple',
