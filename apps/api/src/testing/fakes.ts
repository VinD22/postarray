...
export function testConfig(overrides: Partial<RelayConfig> = {}): RelayConfig {
  const base = {
    ...
    providers: {
      ...
      reddit: { clientId: undefined, clientSecret: undefined },
      wordpress: { clientId: undefined, clientSecret: undefined },
      medium: { clientId: undefined, clientSecret: undefined },
      devto: { apiKey: undefined },
      pinterest: { clientId: undefined, clientSecret: undefined },
      discord: { botToken: undefined },
      slack: { clientId: undefined, clientSecret: undefined },
    },
    presentKeys: [],
  };
