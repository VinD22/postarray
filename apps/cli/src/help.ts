...
export const CLI_HELP = {
  ...
  suggestGroup: { key: 'cli.help.suggest.group' },
  suggestRun: { key: 'cli.help.suggest.run' },
  suggestReview: { key: 'cli.help.suggest.review' },
  suggestAccept: { key: 'cli.help.suggest.accept' },
  suggestBestTime: { key: 'cli.help.suggest.bestTime' },
